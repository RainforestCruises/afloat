jQuery(document).ready(function ($) {
  ...
  window.onclick = function (event) {
    ...
    if (event.target == gettingThereModal) {
      gettingThereModal.classList.remove("active");
      body.removeClass("no-scroll");
    }
  };
