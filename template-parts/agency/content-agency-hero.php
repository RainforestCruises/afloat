...
<div class="agency-hero">
    <div class="agency-hero__content">
        ...
        <h1 class="agency-hero__content__title">
            <?php echo $hero_title ?>
        </h1>

        <div class="agency-hero__content__snippet">
            <?php echo $hero_snippet ?>
        </div>
    </div>
    <div class="agency-hero__image">
