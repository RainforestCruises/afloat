          ...
          <form class="home-hero__content__search-form" action="<?php echo site_url() ?>/wp-admin/admin-ajax.php" method="POST" id="search-form">
              ...
              <div class="home-hero__content__search-form__form-group">
                  ...
                  <div class="home-hero__content__search-form__form-group__input-group">
                      <label for="destination" class="home-hero__content__search-form__form-group__input-group__label" id="chosen-value-label">Destination</label>
              ...
              <div class="home-hero__content__search-form__form-group">
                  ...
                  <div class="home-hero__content__search-form__form-group__input-group">
                      <label for="dates" class="home-hero__content__search-form__form-group__input-group__label" id="date-label">Travel
                          Date</label>
